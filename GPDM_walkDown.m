...
jointAngleMeanDown = [phase' jointAngleMean];
writematrix(jointAngleMeanDown, 'jointAngleMeanDown.txt')
...
trainData_walkDown = [trainIMU trainXpred trainPropagation trainAngle];

save('trainData_walkDown.mat','trainData_walkDown')
writematrix(trainData_walkDown,'trainData_walkDown.csv') 
