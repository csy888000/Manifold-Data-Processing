...
heelLeftValueSave = walkAll.heelLeftValueSave;
heelRightValueSave = walkAll.heelRightValueSave;
walkSeg = walkAll.walkSeg;
imuSeg = walkAll.imuSeg;
jointTh = walkAll.jointTh(:,1:6);
imuTrial = walkAll.imuTrial;
...
jointAngleMeanUp = [phase' jointAngleMean];
writematrix(jointAngleMeanUp, 'jointAngleMeanUp.txt')
...
trainData_walkUp = [trainIMU trainXpred trainPropagation trainAngle];

save('trainData_walkUp.mat','trainData_walkUp')
writematrix(trainData_walkUp,'trainData_walkUp.csv') 
