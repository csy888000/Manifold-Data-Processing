...
jointAngleMeanFlat = [phase' jointAngleMean];
writematrix(jointAngleMeanFlat, 'jointAngleMeanFlat.txt')
...
trainData_walkAll = [trainIMU trainXpred trainPropagation trainAngle];

save('trainData_walkAll.mat','trainData_walkAll')
writematrix(trainData_walkAll,'trainData_walkAll.csv') 
