...
%%
load MatSave/walkFlat.mat

heelLeftValueSave = walkFlat.heelLeftValueSave;
heelRightValueSave = walkFlat.heelRightValueSave;
walkSeg = walkFlat.walkSeg;
imuSeg = walkFlat.imuSeg;
jointTh = walkFlat.jointTh;
imuTrial = walkFlat.imuTrial;
...
angleLen = 125;
jointAngleMean = zeros(angleLen,6);
for i = 1:length(jointAngle)
    for j = 1:6
...
trainData = [trainIMU trainXpred trainPropagation];

save('trainData.mat','trainData')
writematrix(trainData,'trainData.csv') 
